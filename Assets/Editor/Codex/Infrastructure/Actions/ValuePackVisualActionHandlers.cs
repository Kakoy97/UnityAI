...
namespace UnityAI.Editor.Codex.Infrastructure.Actions
{
    ...
    // R21-detox: removed 12 deprecated Handler classes:
    //   SetGameObjectActiveHandler, RenameGameObjectHandler, DestroyGameObjectHandler,
    //   SetTransformLocalPositionHandler, SetTransformLocalRotationHandler, SetTransformLocalScaleHandler,
    //   SetTransformWorldPositionHandler, SetTransformWorldRotationHandler,
    //   SetRectTransformAnchoredPositionHandler, SetRectTransformSizeDeltaHandler,
    //   SetRectTransformPivotHandler, SetRectTransformAnchorsHandler.
    // L2 canonicalizes to canonical action types; canonical handlers serve all traffic.
