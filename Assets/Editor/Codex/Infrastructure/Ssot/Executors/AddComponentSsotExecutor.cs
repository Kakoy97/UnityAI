...
{
    public sealed class AddComponentSsotExecutor
    {
        public SsotDispatchResponse Execute(AddComponentRequestDto request)
        {
            if (request == null)
            {
                return SsotRequestDispatcher.Failure(
                    "E_SSOT_SCHEMA_INVALID",
                    "add_component request payload is required.",
            ...
            if (string.IsNullOrEmpty(componentTypeName))
            {
                return SsotRequestDispatcher.Failure(
                    "E_SSOT_SCHEMA_INVALID",
                    "add_component requires component_type.",
                    AddComponentRequestDto.ToolName);
            }
            ...
            if (componentType == null || !typeof(Component).IsAssignableFrom(componentType))
            {
                return SsotRequestDispatcher.Failure(
                    ...
                    "add_component cannot resolve component_type to a Unity Component.",
                    AddComponentRequestDto.ToolName);
            }
            ...
            if (component == null)
            {
                return SsotRequestDispatcher.Failure(
                    ...
                    "add_component failed to attach component to target.",
                    AddComponentRequestDto.ToolName);
            }
